...
static uint32_t DCD_HandleInEP_ISR(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  while ( ep_intr )
  {
    if (ep_intr&0x1)  
    {
      ...
      if ( diepint.b.ahberr )
      {
        diepint . d32=0; diepint . b . ahberr = 1; (*(volatile uint32_t *)&pdev->regs . INEP_REGS[epnum]->DIEPINT = diepint . d32);;
      }
      ...
      {
        diepint . d32=0; diepint . b . intknepmis = 1; (*(volatile uint32_t *)&pdev->regs . INEP_REGS[epnum]->DIEPINT = diepint . d32);;
      }
      ...
      if (diepint.b.emptyintr)
      {
        ...
        diepint . d32=0; diepint . b . emptyintr = 1; (*(volatile uint32_t *)&pdev->regs . INEP_REGS[epnum]->DIEPINT = diepint . d32);;
      }
    }
    epnum++;
    ep_intr >>= 1;
...
static uint32_t DCD_HandleOutEP_ISR(USB_OTG_CORE_HANDLE *pdev)
{
  ...
  while ( ep_intr )
  {
    if (ep_intr&0x1)
    {
      ...
      if ( doepint.b.ahberr )
      {
        doepint . d32=0; doepint . b . ahberr = 1; (*(volatile uint32_t *)&pdev->regs . OUTEP_REGS[epnum]->DOEPINT = doepint . d32);;
      }
