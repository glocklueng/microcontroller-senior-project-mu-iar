...
volatile static char  UpdateLcd;
...
void port_init()
{
  ...
  GPIO_InitStruct.GPIO_Pin  = ((uint16_t)0x0400) | ((uint16_t)0x8000) | ((uint16_t)0x0020);        
  GPIO_InitStruct.GPIO_Mode = GPIO_Mode_OUT;
  GPIO_InitStruct.GPIO_Speed = GPIO_Speed_25MHz;
  GPIO_InitStruct.GPIO_OType = GPIO_OType_PP;
  GPIO_InitStruct.GPIO_PuPd = GPIO_PuPd_NOPULL;
...
void lcdInit(void)
{
   port_init();
   delay_ms(10); 
   GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0400));					
   GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x0400));
...
void lcdSend ( unsigned char Data_Send, LcdCmdData cd )
{
    ...
    if ((((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800))->CR1 & 0x0800) == 0x0800)
    {
    ...
    else 
    {
      ...
      GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), ((uint16_t)0x8000));
    }
